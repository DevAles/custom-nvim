...
keyset("n", "cr", "<Plug>(coc-references)", { silent = true })
...
keyset("x", "<leader>aa", "<Plug>(coc-codeaction-selected)", opts)
keyset("n", "<leader>aa", "<Plug>(coc-codeaction-selected)", opts)
...
keyset("n", "<leader>rr", "<Plug>(coc-codeaction-refactor-selected)", { silent = true })
...
keyset("n", "<space>oo", ":<C-u>CocList outline<cr>", opts)
-- Search workspace symbols
keyset("n", "<space>sy", ":<C-u>CocList -I symbols<cr>", opts)
-- Do default action for next item
keyset("n", "<space>jj", ":<C-u>CocNext<cr>", opts)
-- Do default action for previous item
keyset("n", "<space>kk", ":<C-u>CocPrev<cr>", opts)
-- Resume latest coc list
keyset("n", "<space>pp", ":<C-u>CocListResume<cr>", opts)
